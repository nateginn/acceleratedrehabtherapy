...
@jinja2.extension
class FormHelperExtension(jinja2.Extension):
    tags = {'render_form', 'render_field'}
    takes_context = True

    def _render_form(self, context, form, template='form_helper/form.html'):
        """
            Рендеринг формы.
    ...
    def _render_field(self, context, form, fieldname, template=None, classes=None, help_text=None, **kwargs):
        """
