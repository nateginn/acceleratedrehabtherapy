# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-11-11 09:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', libs.stdimage.fields.StdImageField(aspects='normal', blank=True, min_dimensions=(590, 395), storage=libs.storages.media_storage.MediaStorage('blocks/location/img'), upload_to='', variations={'admin': {'crop': False, 'size': (300, 150)}, 'mobile': {'size': (295, 200)}, 'normal': {'size': (590, 395)}}, verbose_name='image')),
            ],
            options={
