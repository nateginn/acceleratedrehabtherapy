...
@jinja2.extension
class ShareButtonExtension(jinja2.Extension):
    tags = {'share_button'}
    takes_context = True

    def _share_button(self, context, provider, text='', url='', title='', description='', image='', template='social_networks/share_button.html'):
