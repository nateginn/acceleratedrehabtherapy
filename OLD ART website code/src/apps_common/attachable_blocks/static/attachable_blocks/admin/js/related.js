(function($) {
    ...
    var init_field = function($field) {
        var $inlineGroup = $field.closest('.inline-group');
        if (!$inlineGroup.length) {
            return
        }

        var inlineGroupData = $inlineGroup.data();
