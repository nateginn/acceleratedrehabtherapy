(function($) {
    ...
    window.GMapCluster = Class(GMapCustomMarker, function GMapCluster(cls, superclass) {
        ...
        cls.fitBounds = function() {
            this._map.native.fitBounds(this.bounds);
            return this;
        };
    ...
    window.GMapClusterManager = Class(GMapOverlayBase, function GMapClusterManager(cls, superclass) {
        ...
        cls._createCluster = function(marker) {
            ...
            google.maps.event.addDomListener(cluster.$container.get(0), 'mousedown', function() {
                isDragging = false;
            });
            google.maps.event.addDomListener(cluster.$container.get(0), 'mousemove', function() {
                isDragging = true;
            });
