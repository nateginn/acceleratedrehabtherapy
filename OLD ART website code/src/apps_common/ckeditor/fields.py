...
class CKEditorUploadField(models.Field):
    ...
    def __init__(self, *args, editor_options=None, height=420, upload_pagephoto_url='',
        ...
        kwargs.setdefault('help_text', 'Image sizes: from <b>{}x{}</b> to <b>{wide_width}x{wide_height}</b>'.format(
            wide_width=wide_width, wide_height=wide_height, *PagePhoto.photo.min_dimensions
        ))
        super().__init__(*args, **kwargs)
